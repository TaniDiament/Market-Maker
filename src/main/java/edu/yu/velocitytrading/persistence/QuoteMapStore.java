...
public class QuoteMapStore implements MapStore<String, Quote> {
    ...
    private final edu.yu.velocitytrading.persistence.interfaces.JpaQuoteRepository quoteRepository;

    public QuoteMapStore(edu.yu.velocitytrading.persistence.interfaces.JpaQuoteRepository repository) {
